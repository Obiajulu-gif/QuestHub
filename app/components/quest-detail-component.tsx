...
// Define Badge type inline to avoid potential import conflicts
interface Badge {
  id: string
  name: string
  description: string
...
interface QuestDetailComponentProps {
  questId: string
  title: string
  description: string
  difficulty: string
...
// Create a separate named export for use in pages
export { QuestDetailComponent as QuestDetail }
